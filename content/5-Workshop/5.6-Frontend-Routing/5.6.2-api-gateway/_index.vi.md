...
![Network request EC2](/images/5-Workshop/5.6-Frontend-Routing/network-request-ec2.jpg)
...
![API Gateway integration](/images/5-Workshop/5.6-Frontend-Routing/api-gateway-integration.jpg)

#### 3. Deploy stage mặc định

Tại phần **Stages**, dùng stage `$default` và bật **Automatic deployment**.

![API Gateway stage](/images/5-Workshop/5.6-Frontend-Routing/api-gateway-stage.jpg)
